...
class AuthController {
            ...
            if(empty($alertas)) {
                ...
                if(!$usuario || !$usuario->confirmado ) {
                    ...
                    if( password_verify($_POST['password'], $usuario->password) ) {
                        ...
                        Usuario::setAlerta('danger', 'Password Incorrecto');
                    }
                }
            }
        }
    ...
    public static function reestablecer(Router $router) {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST' && $token_valido === true) {
    ...
    public static function confirmar(Router $router) {
        ...
        if(empty($usuario)) {
            ...
            Usuario::setAlerta('danger', 'Token No Válido');
        } else {
            // Confirmar la cuenta
            ...
            Usuario::setAlerta('success', 'Cuenta Comprobada Correctamente, puedes iniciar sesión.');
        }
